...
const TEAM_MEMBERS = [
  {
    ...
    name: "Akshay K",
    role: "CEO & Founder",
    bio: "Akshay has over 8 years of experience in strategic leadership and business development.",
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dzjxexhzf/image/upload/v1772125329/nishal_c2gzz4.jpg",
  },
  {
    type: "image",
    name: "Nishmitha V G",
    role: "UI/UX Designer",
    image:
      "https://res.cloudinary.com/dzjxexhzf/image/upload/v1772125545/nishmitha_krs5xs.jpg",
  },
  {
    type: "image",
...
const VALUES = [
  {
    ...
    description:
      "We believe speed and quality aren't mutually exclusive. Every sprint delivers working software.",
  },
  {
    title: "Founders First",
    description:
      "We treat every project like it's our own startup. Your success is our success.",
  },
  {
    title: "Transparent Always",
    description:
      "Weekly demos, honest timelines, no surprises. You see what we build as we build it.",
  },
];
...
const CULTURE_PERKS = [
  {
    ...
    description:
      "No silos. Engineers, designers, and founders work side-by-side to solve complex product challenges together.",
  },
  {
    icon: Zap,
    title: "Empowered to Act",
    description:
      "We hire smart people and get out of their way. Everyone has a voice in the product architecture.",
  },
  {
    icon: Coffee,
    title: "Bangalore HQ",
    description:
      "Operating from the Silicon Valley of India, surrounded by top-tier talent and an incredible tech ecosystem.",
  },
  {
    icon: Heart,
    title: "Work-Life Integration",
    description:
      "We sprint hard, but we know burnout doesn't build good software. We prioritize health and sustainable pacing.",
  },
];
          ...
          <div className="max-w-[90rem] mx-auto px-6 sm:px-12 lg:px-16">
            <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 lg:gap-16 mb-20 lg:mb-24">
              ...
              <p className="text-lg lg:text-[1.125rem] text-black/70 leading-relaxed lg:w-1/2 lg:mt-3">
                ...
                product thinkers based in Bangalore, India. We help ambitious
                startups turn ideas into live products — fast.
              </p>
            </div>
                      ...
                      <div className="flex items-center gap-5 text-white mt-8">
                        ...
                        {member.socials?.twitter && (
                          <a
                            ...
                            className="hover:text-white transition-colors text-black duration-300 bg-gray-200 rounded-md p-1"
                          >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 text-center z-10">
                      <h3 className="text-xl font-medium text-white mb-1 drop-shadow-sm">
                        {member.name}
                      </h3>
        ...
        <section className="py-24  bg-white">
          <div className="max-w-[90rem] mx-auto px-6 sm:px-12 lg:px-16">
            <div className="text-center mb-20 md:mb-24">
              ...
              <p className="text-lg lg:text-[1.125rem] text-black/70 max-w-2xl mx-auto leading-relaxed">
                Our values aren&apos;t wall posters — they&apos;re how we
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-12 md:gap-y-0 divide-y md:divide-y-0 md:divide-x divide-gray-200">
              {VALUES.map((value, index) => (
                ...
                >
                  ...
                  <span className="text-[11px] font-bold tracking-[0.2em] text-black/70 mb-6 block uppercase">
                    0{index + 1} &mdash;
                  </span>
                  ...
                  <p className="text-black/70 leading-relaxed text-[1.05rem]">
                    {value.description}
                  </p>
                </div>
              ))}
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-black/70 leading-relaxed">
                  Great software isn't built in a vacuum. It’s built by people
                  who enjoy working together, challenging each other, and
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 mb-4 lg:mb-6">
              <div className="lg:col-span-5 lg:pr-8">
                <h2 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-medium tracking-tight leading-[1.1]">
                  ...
                  <br className="hidden lg:block" /> for builders.
                </h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-5 lg:pr-8">
                <p className="text-lg text-white/50 leading-relaxed">
                  We are deeply invested in the growth and well-being of our
                  team. When you work with Enlivo, you are partnering with a
                  team that is motivated, supported, and equipped to do the best
                  work of their lives.
                </p>
              </div>
              ...
              <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2">
                {CULTURE_PERKS.map((perk, index) => {
                  ...
                  if (index === 0) {
                    // Top Left
                    gridClasses =
                      "pb-10 sm:pb-12 border-b border-white/15 border-dashed sm:border-r sm:pr-8 lg:pr-12";
                  } else if (index === 1) {
                    // Top Right
                    gridClasses =
                      "py-10 sm:py-0 sm:pb-12 border-b border-white/15 border-dashed sm:pl-8 lg:pl-12";
                  } else if (index === 2) {
                    // Bottom Left
                    gridClasses =
                      "py-10 sm:py-0 sm:pt-12 border-b sm:border-b-0 border-white/15 border-dashed sm:border-r sm:pr-8 lg:pr-12";
                  } else if (index === 3) {
                    // Bottom Right
                  ...
                  return (
                    <div
                      key={index}
                      className={`flex items-start gap-4 sm:gap-6 ${gridClasses}`}
                    >
                      ...
                      <div>
                        <h3 className="text-[1.15rem] font-medium mb-2 text-white">
                          {perk.title}
                        </h3>
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-10 px-6">
                <div className="max-w-4xl mx-auto space-y-8">
                  ...
                  <p className="text-lg lg:text-[1.125rem] text-white/90 font-normal drop-shadow-md max-w-2xl mx-auto">
                    We're selective about who we work with — and so are you. If
                    it feels like a fit, let's find out.
                  </p>
