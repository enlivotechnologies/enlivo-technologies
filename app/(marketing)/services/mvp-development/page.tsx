...
export const metadata: Metadata = buildMetadata({
  title: "MVP & Product Development Services | Enlivo Technologies",
  description:
    "Rapidly build and launch your minimum viable product with a focus on core features that deliver value to your users from day one. Expert MVP development services for startups and entrepreneurs.",
  keywords: [
    "MVP development",
