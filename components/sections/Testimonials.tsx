...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    text: "The team balanced UX, performance, and security without overengineering.",
  },
  {
    id: 2,
    type: "video",
    name: "Sarah Jenkins",
    // Optimization: Added f_auto,q_auto to Cloudinary URL
    image: "https://res.cloudinary.com/dqmryiyhz/video/upload/f_auto,q_auto/v1768464062/Untitled_design_1_vmz5hb.mp4",
  },
  {
    id: 3,
    type: "text",
    ...
    text: "Enlivo helped stabilize and scale systems under production load.",
  },
  {
    id: 4,
    type: "video",
    name: "Satyam Vyas",
    image: "https://res.cloudinary.com/dqmryiyhz/video/upload/f_auto,q_auto/v1768462714/Untitled_design_scbpxt.mp4",
  },
  {
    id: 5,
    type: "video",
    name: "Olivia",
    image: "https://res.cloudinary.com/dqmryiyhz/video/upload/f_auto,q_auto/v1768464308/Untitled_design_2_hxk8qe.mp4",
  },
  {
    id: 6,
    type: "text",
    ...
    text: "Enlivo worked closely with our internal teams to modernize legacy systems.",
  },
  {
    id: 7,
    type: "video",
    name: "James Carter",
    image: "https://res.cloudinary.com/dqmryiyhz/video/upload/f_auto,q_auto/v1768464802/Untitled_design_3_pkbjtp.mp4",
  },
  {
    id: 8,
    type: "text",
    ...
    text: "Clear communication and strong engineering discipline made them a reliable partner.",
  },
];
...
function ReviewCard({ data }: { data: Testimonial }) {
  return (
    <figure className={cn(
      ...
      "hover:bg-[#111113] hover:border-white/[0.15] transition-all duration-300 flex flex-col justify-between"
    )}>
      <div>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="text-[14px] font-semibold text-white leading-tight">{data.name}</div>
        </div>
...
function PhotoCard({ data }: { data: Testimonial }) {
  ...
  // Optimization: Generate a static poster image URL from the video URL for lazy loading
  const posterUrl = isVideo 
    ? data.image.replace("/video/upload/", "/video/upload/so_0,f_jpg,q_auto/").replace(".mp4", ".jpg") 
    : "";

  return (
    <figure className={cn(
      "relative w-[260px] h-[260px] overflow-hidden rounded-2xl border border-white/[0.08] group bg-[#09090b]"
    )}>
      {isVideo ? (
        <video
          src={data.image}
          poster={posterUrl}
          preload="none" // Optimization: Stop browser from downloading video until visible
