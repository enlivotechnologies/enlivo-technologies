...
export function TrustStatement() {
  ...
  useEffect(() => {
    ...
    Promise.all([loadGSAP(), loadScrollTrigger()]).then(
      ([gsap, ScrollTrigger]) => {
  ...
  return (
    ...
    >
      <div className="relative z-10 w-full max-w-[90rem] mx-auto px-6 sm:px-12 lg:px-16">
        ...
        <div ref={quoteRef} className="relative w-full max-w-[90rem] mx-auto">
          ...
          <div className="mb-16 flex flex-col items-end">
            <p className="text-3xl md:text-4xl lg:text-[2.75rem] font-medium text-gray-900 leading-[1.2] tracking-tight max-w-5xl text-right">
              “I personally lead every project. You work directly with me, not
              account managers or junior developers. I review every line of code
              before it ships.”
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-end justify-between gap-10 w-full">
            ...
            <div className="flex flex-row items-center gap-5 text-left">
              ...
              <div className="flex flex-col gap-0.5">
                <p className="text-xl font-medium text-gray-900">Akshay K</p>
            ...
            <div className="flex-shrink-0">
              <div className="flex items-center gap-6 text-[11px] font-medium uppercase text-black">
                <a
                  href="https://www.linkedin.com/in/akshay-roy-enlivo?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                  target="_blank"
                ...
                <a
                  href="mailto:royakshay0559@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-blue-600 transition-colors"
                >
